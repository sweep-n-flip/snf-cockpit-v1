 ...
 */
export function initWeb3Provider(chainId: string, rpcUrl: string): JsonRpcProvider {
 ...
 */
export function getWeb3Provider(chainId: string): JsonRpcProvider | undefined {
  if (!chainProviders[chainId]) {
...
export function setupDefaultWeb3Providers(): void {
  // Ethereum Mainnet
  initWeb3Provider('1', 'https://eth-mainnet.g.alchemy.com/v2/demo')

  // Arbitrum
  initWeb3Provider('42161', 'https://arb-mainnet.g.alchemy.com/v2/demo')

  // Base
  initWeb3Provider('8453', 'https://mainnet.base.org')

  // Mode
  initWeb3Provider('34443', 'https://mainnet.mode.network')
